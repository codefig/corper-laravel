...
<body>
    ...
    <div id="wrapper">
                      ...
                      <li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="{{ route('admin.agent.viewall') }}">View Agents and Mentees </a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.agent.viewreviews') }}">View Corper Reviews </a>
                                </li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                               ...
                               <li>
                                    <a href="{{ route('admin.posted.view') }}">View Corper Reviews </a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Attach corper to agent</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    ...
                    <form method="post" action="{{ route('admin.unposted.submit') }}">

                    <div class='form-group'>
                        <label> Corper's Name </label>
                        <input class="form-control form-control-danger" style=""type="text" value="{{ $user->firstname . " ". $user->lastname }}">
                        <input type="text" style="visibility:hidden" name="user_id" value="{{ $user->id }}">
                    </div>
                  ...
                  <div class="form-group">
                      ...
                      <span class="fa fa-user-o"></span><input type="submit" class="btn btn-primary" value="Post Corper">
                  </div>
