...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
       ...
       <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Charts">
          <a class="nav-link" href="{{ route('agent.makereview') }}">
            <i class="fa fa-fw fa-area-chart"></i>
            <span class="nav-link-text">Make Reviews</span>
          </a>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
          <a class="nav-link" href="{{ route('agent.showcorpers') }}">
            <i class="fa fa-fw fa-table"></i>
            <span class="nav-link-text">Show Corpers</span>
          </a>
        </li>
      </ul>
  ...
  <div class="content-wrapper">
          ...
          <div class="container">
            @if(count($review) > 0)
              ...
              <div class="form-group">
                ...
                <label> Comment </label>
                <textarea class="form-control" readonly>{{ $review->comments }}</textarea>
              </div>
              @else
                <div class='alert alert-danger'>
                  <span> Sorry, You haven't made any review for the chosen month ! </span>
                </div>
            @endif
    ...
    <script src="{{ URL::to('js2/sb-admin.min.js') }}"></script>
  </div>
</body>
